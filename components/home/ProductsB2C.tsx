    ...
    <section className="py-24 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4">Premium Communication Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <div className="inline-block text-sm font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 px-3 py-1 rounded-full mb-4">
              Featured Product
            </div>
            <h3 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-slate-100 mb-4">{b2cProducts[0].name}</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              {persistFeatures.map((feature, index) => (
                <div key={index} className="flex items-start gap-3">
                  <div className="text-primary-500 dark:text-primary-400 text-lg mt-1">
                    <CheckCircleIcon />
                  </div>
                  <div>
                    <h4 className="font-medium text-slate-800 dark:text-slate-200">{feature.title}</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link 
                ...
                className="text-primary-600 dark:text-primary-400 border border-primary-600 dark:border-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 font-medium py-2 px-6 rounded-md transition duration-300 text-center"
              >
                Learn More
              </Link>
            </div>
          ...
          <div className="rounded-xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-700 relative">
            ...
            >
              <rect width="800" height="600" fill="#F8FAFC" className="dark:fill-slate-900" />
              <rect x="50" y="50" width="700" height="500" rx="8" fill="#FFFFFF" stroke="#E2E8F0" strokeWidth="2" className="dark:fill-slate-800 dark:stroke-slate-700" />
              
              {/* Left sidebar */}
              <rect x="50" y="50" width="200" height="500" fill="#F1F5F9" rx="8 0 0 8" className="dark:fill-slate-700" />
              
              {/* Channel list */}
              <rect x="70" y="90" width="160" height="30" rx="4" fill="#E2E8F0" className="dark:fill-slate-600" />
              <rect x="70" y="130" width="160" height="30" rx="4" fill="#3B82F6" />
              <rect x="70" y="170" width="160" height="30" rx="4" fill="#E2E8F0" className="dark:fill-slate-600" />
              <rect x="70" y="210" width="160" height="30" rx="4" fill="#E2E8F0" className="dark:fill-slate-600" />
              <rect x="70" y="250" width="160" height="30" rx="4" fill="#E2E8F0" className="dark:fill-slate-600" />
              
              {/* Message history */}
              <rect x="270" y="90" width="460" height="400" rx="4" fill="#F8FAFC" className="dark:fill-slate-800" />
              
              {/* Messages */}
              <rect x="290" y="110" width="400" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              <rect x="290" y="160" width="350" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              <rect x="290" y="210" width="420" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              <rect x="290" y="260" width="380" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              <rect x="290" y="310" width="400" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              <rect x="290" y="360" width="350" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              <rect x="290" y="410" width="420" height="40" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              
              {/* Message input */}
              <rect x="270" y="500" width="460" height="50" rx="4" fill="#F1F5F9" className="dark:fill-slate-700" />
              ...
              {/* Header */}
              <rect x="50" y="50" width="700" height="50" fill="#FFFFFF" stroke="#E2E8F0" strokeWidth="2" className="dark:fill-slate-800 dark:stroke-slate-700" />
              <text x="270" y="80" fontFamily="Arial" fontSize="16" fontWeight="bold" fill="#0F172A" className="dark:fill-slate-200">General Chat - History Available</text>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* RelayOS Communities™ */}
          <div className="flex flex-col md:flex-row gap-6 p-6 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
            <div className="md:w-1/3">
              ...
              >
                <rect width="400" height="300" rx="8" fill="#F8FAFC" className="dark:fill-slate-900" />
            ...
            <div className="md:w-2/3">
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">{b2cProducts[1].name}</h3>
          ...
          <div className="flex flex-col md:flex-row gap-6 p-6 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
            ...
            <div className="md:w-2/3">
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">AI-Enhanced Interaction</h3>
              <p className="text-slate-600 dark:text-slate-400 mb-4">
