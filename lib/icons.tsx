...
export const SunIcon = ({ className }: IconProps): JSX.Element => (
  <Icon icon="fa-sun" className={className} />
);

export const MoonIcon = ({ className }: IconProps): JSX.Element => (
  <Icon icon="fa-moon" className={className} />
);
...
export const XIcon = ({ className }: IconProps): JSX.Element => (
  <Icon icon="fa-times" className={className} />
);
